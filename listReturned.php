                    ...
                    <div class="col-lg-12">
						...
						<?php
                            $connection = mysqli_connect('localhost', 'root', '');
                                ...
                                $query = 'SELECT returned.IMEI, concat("iPhone ", type, " ", Color,  " ", size, "gb"), IOS_Version, buyer.name, returned.return_date, returned.Issues FROM buyer, returned, iPhone WHERE (returned.buyer_ID=buyer.id) AND (returned.IMEI=iPhone.IMEI)';
